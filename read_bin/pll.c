...
#ifdef JLINK_CUSTOM_PLL
//default DDR800
static unsigned int pllc1_mempll_n_info_30_24_n4	= (0x0000004e << 25);
static unsigned int pllc1_mempll_n_info_23_0_n4		= (0x00d89d89 << 1);
static unsigned int mempll2_m4pdiv_1_0			= (0x00000000 << 10);
static unsigned int mempll2_fbdiv_6_0			= (0x00000008 << 2);
static unsigned int mempll3_m4pdiv_1_0			= (0x00000000 <<10);
static unsigned int mempll3_fbdiv_6_0			= (0x00000008 << 2);
static unsigned int mempll4_m4pdiv_1_0			= (0x00000000 << 10);
static unsigned int mempll4_fbdiv_6_0			= (0x00000008 << 2);

void jlink_update_pll_para(int pll_bps)
{
