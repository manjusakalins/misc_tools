...
def load_xlsx_data(f_path, sheet_name, time_col, vol_col, row_s, row_e, in_r, dis_c):
    print f_path
...
def read_xls_to_gen_ocv_table_same_r(in_f, sheet_name, time_col, vol_col, row_s, row_e, in_r, dis_c):
    ...
    load_xlsx_data(f_path, sheet_name, time_col, vol_col, row_s, row_e, in_r, dis_c);
...
#read_xls_to_gen_ocv_table_same_r("./test.xlsx", "Record", 3, 5, 1139, 2730, 60, 2000);
